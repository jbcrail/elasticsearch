...
/**
 * A request to get top N details
 */
public class GetTopNRequest extends ActionRequest implements IndicesRequest {
    ...
    public GetTopNRequest() {
        this(null, null);
    }

    public GetTopNRequest(Integer sampleSize, QueryBuilder query) {
        this.sampleSize = sampleSize;
        this.query = query;
    }

    public GetTopNRequest(StreamInput in) throws IOException {
    ...
    public boolean equals(Object o) {
        ...
        GetTopNRequest that = (GetTopNRequest) o;
